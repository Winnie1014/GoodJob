...
- 首版不引入 Implementer/channel 协作基础设施；后续实现继续以小范围变更、测试、审查和独立提交推进。
...
| 技术栈与离线产物 | D-022 至 D-027、D-030、D-040、D-042 | ADR-0002、ADR-0008、产物与学习闭环、看板呈现契约 |
| 项目访谈、模拟面试与复习 | D-029、D-032、D-033 | ADR-0002、ADR-0007、产物与学习闭环、验收基线 |
| 运行恢复与个人数据保留 | D-037、D-038 | 系统设计、证据模型、验收基线 |
| 不可信输入与安全呈现 | D-036、D-041 | ADR-0008、系统设计、扫描与分析设计、证据模型、看板呈现契约 |
