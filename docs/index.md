...
| [ADR-0011](30-decisions/adrs/ADR-0011-native-windows-security-contract.md) | 已接受（2026-08-14；§3 两项被 ADR-0012 部分替代） | 原生 Windows 的 WFP/Job、NT handle-relative FS、direct launcher/capability handle、所有权与 fail-closed 基础契约 | rename/publish primitive 与目录枚举 cursor 以 ADR-0012 为准 |
| [ADR-0012](30-decisions/adrs/ADR-0012-windows-nt-rename-and-directory-enumeration-correction.md) | 已接受（2026-08-16） | Windows NT class 10 rename/publish 与每次独立目录枚举的 cursor 契约 | 不替代 ADR-0011 的其他 FS/WFP/Job/launcher/ownership 决策；IMP-31 未通过前仍 unsupported |
