...
> 状态：已接受（平台限定部分由 [ADR-0009](ADR-0009-cross-platform-runtime-security.md) 替代；Codex-only 入口与数据目录绑定部分拟由待接受的 [ADR-0010](ADR-0010-host-agent-neutral-session.md) 替代）
> 日期：2026-07-24  
