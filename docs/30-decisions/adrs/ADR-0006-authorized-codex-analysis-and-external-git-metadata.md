...
> 状态：已接受（macOS-only Git 沙箱前提由 [ADR-0009](ADR-0009-cross-platform-runtime-security.md) 扩展为 macOS/Linux 双平台；Codex 专属 SessionCapability 与 issuer_kind 绑定已由 [ADR-0010](ADR-0010-host-agent-neutral-session.md) 替代；决策 3 的 POSIX FD 传输条款已由 [ADR-0011](ADR-0011-native-windows-security-contract.md) 扩展为原生 Windows allowlisted inherited HANDLE）
> 日期：2026-07-24  
