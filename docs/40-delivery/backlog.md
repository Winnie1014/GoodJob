...
| --- | --- | --- | --- | --- | --- |
| GJ-13 · 建立发布验收证据账本 | [GJ-13](../collab/tasks/GJ-13.md) | 待领取（新 Implementer 首卡） | M1 已合入 | 常规 | 条件 2、4 的事实基线 |
| GJ-14 · 合成工作区全链路验收 | 待 GJ-13 后出卡 | 待出卡 | GJ-13 | 对抗 | 条件 2；条件 3 前置 |
| GJ-15 · 看板机检缺口闭合 | 待 GJ-13 后出卡 | 待出卡 | GJ-13 | 对抗 | 条件 4 机检部分 |
